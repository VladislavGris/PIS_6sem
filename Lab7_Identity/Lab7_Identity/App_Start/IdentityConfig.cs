...
namespace Lab7_Identity
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            {
                RequiredLength = 6,                 // Минимальная длина
                RequireNonLetterOrDigit = false,     // Наличие спец. символа
                RequireDigit = false,                // Наличие цифры
                RequireLowercase = false,            // Наличие буквы в нижнем регистре
                RequireUppercase = false,            // Наличие буквы в верхнем регистре
            };
